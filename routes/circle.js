...
module.exports = function(app, ctrl) {
  ...
  app.delete('/circle_contents/:contentId/comments/:commentId', token.needToken, ctrl.getCircleContentById, ctrl.deleteCircleComment);
  ...
  // app.get('/circle_reminds/comments', token.needToken, ctrl.getCircleComments);
  // ## 辅助api
  // get /teams?query 获取小队列表(在现在基础上添加功能)  done
  // get /campaigns?query 获取活动列表(在现在基础上添加功能)  done
};