...
module.exports = function () {
  describe('get /campaigns', function () {
    ...
    getCampaignTest('应该成功获取个人未参加活动',{requestType:'user',join_flag:'0'},9);//TODO: 3
    getCampaignTest('应该成功获取个人即将开始活动',{requestType:'user',select_type:'1'},0);//TODO:2
    getCampaignTest('应该成功获取个人正在进行活动',{requestType:'user',select_type:'2'},0);//TODO:2
    getCampaignTest('应该成功获取个人可参加活动',{requestType:'user',select_type:'3'},0);//TODO:2
