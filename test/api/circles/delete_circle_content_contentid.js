...
module.exports = function() {
  ...
  describe('delete /circle_contents', function() {
    describe('本公司成员', function() {
      it('本公司用户应能删除自己的朋友圈消息', function(done) {
        request.delete('/circle_contents/' + data[1].circles[0].content._id)
      ...
      it('本公司用户不能删除其他用户朋友圈消息', function(done) {
        request.delete('/circle_contents/' + data[1].circles[1].content._id)
      ...
      it('本公司用户不能删除其他公司用户朋友圈消息', function(done) {
        request.delete('/circle_contents/' + data[0].circles[1].content._id)
          .set('x-access-token', userToken1)
          .expect(403)
          .end(function(err, res) {
            if (err) return done(err);
