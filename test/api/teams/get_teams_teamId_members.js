...
module.exports = function() {
  ...
  describe('get /teams/:teamId/members', function() {
    ...
    it('有效用户获取所在小队队员信息', function(done) {
      var data = dataService.getData();
      var user = data[0].users[0];
    ...
    it('有效用户获取所在公司其他小队队员信息', function(done) {
      var data = dataService.getData();
    ...
    it('有效用户获取其他公司小队队员信息，权限不够', function(done) {
      var data = dataService.getData();
      var user = data[0].users[0];
    ...
    it('有效公司获取其公司小队队员信息', function(done) {
      var data = dataService.getData();
      var user = data[0].users[0];
    ...
    it('有效公司获取其他公司小队队员信息，权限不够', function(done) {
      var data = dataService.getData();
