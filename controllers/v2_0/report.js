    ...
    pushReport: function(req, res){
      donlerValidator({
        hostType: {
          ...
          validators: ['required', donlerValidator.enum(['activity', 'poll', 'question', 'photo', 'circle', 'user'])]
        },
        hostId: {
          name: '举报主体ID',
          ...
          if(err){
            ...
            switch(req.body.hostType) {
              case 'user':
                ...
                break;
              case 'circle':
                reportModel = 'CircleContent';
                break;
              case 'activity':
              case 'poll':
              case 'question':
                reportModel = 'Interaction';
                break;
            }
            ...
            .then(function(_reportModel){
              ...
              switch(req.body.hostType) {
                case 'user':
                  ...
                  break;
                case 'circle':
                  content_poster.uid = _reportModel.postUserId;
                  content_poster.cid = _reportModel.cid;
                  break;
                case 'activity':
                case 'poll':
